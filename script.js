document.addEventListener("DOMContentLoaded", () => {
    ...
    const cards = [
        ...
        {
            name:'tobirama',
            img:'images/tobirama.png'
        },

        {
            name:'tsunade',
            img:'images/tsunade.png'
        },
  ...
  function createBoard() {
    for (let i = 0; i < cards.length; i++) {
      ...
      card.setAttribute('src', 'images/board2.png')
  ...
  function checkForMatch() {
    ...
    if(optionOneId == optionTwoId) {
      cards[optionOneId].setAttribute('src', 'images/board2.png')
      cards[optionTwoId].setAttribute('src', 'images/board2.png')
